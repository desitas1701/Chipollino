...
- `Minimize: NFA -> DFA` — минимизация (по Майхиллу-Нероуда) без добавления состояния-ловушки
- `Minimize+: NFA -> DFA` — минимизация (по Майхиллу-Нероуда) с добавлением состояния-ловушки
- `MinimizeH: NFA -> DFA` — минимизация (по Хопкрофту) без добавления состояния-ловушки
- `MinimizeH+: NFA -> DFA` — минимизация (по Хопкрофту) с добавлением состояния-ловушки
